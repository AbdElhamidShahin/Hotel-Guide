...
class _BookingDetailsPageState extends State<BookingDetailsPage> {
  ...
  void initState() {
    super.initState();
    context.read<BookingCubit>().loadUserProfile();
  }
  ...
  double get _subTotal => widget.room.finalPrice * _totalDays * _rooms;
  ...
  BookingModel get _currentBooking => BookingModel(
    ...
    userId: context.read<BookingCubit>().userProfile?.id ?? '',
  ...
  Future<void> _onCardTap() async {
    ...
    cubit.makePayment(
      input: PaymentIntentInputModel(
        ...
        customerId: profile.stripeCustomerId ?? profile.id,
        currency: 'usd',
      ),
